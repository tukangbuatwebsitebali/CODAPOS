...
interface MenuItem {
    ...
    href?: string;
    divider?: boolean;
    permission?: string; // maps to backend action
}

const allMenuItems: MenuItem[] = [
    { label: "Dashboard", icon: LayoutDashboard, href: "/dashboard" },
    { label: "POS Kasir", icon: ShoppingCart, href: "/dashboard/pos", permission: "pos_checkout" },
    { label: "Produk", icon: Package, href: "/dashboard/products", permission: "read_products" },
    { label: "Inventori", icon: Warehouse, href: "/dashboard/inventory", permission: "manage_products" },
    { label: "Transaksi", icon: Receipt, href: "/dashboard/transactions", permission: "read_transactions" },
    { label: "Outlet", icon: Store, href: "/dashboard/outlets", permission: "manage_outlets" },
    ...
    { label: "Pengaturan", icon: Settings, href: "/dashboard/settings", permission: "manage_settings" },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen flex bg-[#0a0a0f] bg-pattern">
            {/* Mobile overlay */}
            {mobileOpen && (
      ...
      `}>
            ...
            <div className="flex-1 min-h-screen flex flex-col">
                {/* Top bar */}
                <header className="sticky top-0 z-30 glass-subtle h-16 flex items-center justify-between px-6 border-b border-white/5">
                ...
                {/* Page content */}
                <main className="flex-1 p-6 bg-gradient-mesh">
                    {children}
                </main>
            </div>
        </div>
