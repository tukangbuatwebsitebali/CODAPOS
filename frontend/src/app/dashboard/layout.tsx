...
const allMenuItems: MenuItem[] = [
    ...
    { label: "Tagihan MDR", icon: FileText, href: "/dashboard/billing", permission: "read_transactions" },
    ...
    { label: "Revenue App", icon: BarChart3, href: "/dashboard/admin/revenue", permission: "super_admin" },
